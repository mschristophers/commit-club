...
async function main() {
  console.log("🚀 Creating more commitments to generate events on Flow EVM Testnet...");
  ...
  const commitments = [
    ...
    {
      name: "DeFi Strategy Meeting",
      stakeAmount: parseEther("0.025"),
      minCheckIns: 5n,
      secretCode: "DEFI2024"
    },
    {
      name: "Blockchain Gaming Night",
    ...
    },
    {
      ...
      stakeAmount: parseEther("0.04"),
      minCheckIns: 6n,
      secretCode: "INVEST2024"
    }
  ];
  ...
  for (let i = 0; i < commitments.length; i++) {
    ...
    console.log("Min Check-ins:", commitment.minCheckIns.toString());
